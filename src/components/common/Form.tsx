...
const Form = ({
  ...
  function sendData(event: any) {
    ...
    const data = Object.fromEntries(new FormData(document.querySelector('#contactForm') as HTMLFormElement));
    const xhr = new XMLHttpRequest();
    xhr.open('POST', "https://ng0utmmw3b.execute-api.eu-central-1.amazonaws.com/PROD/contact");
    xhr.setRequestHeader('Content-Type', 'application/json; charset=UTF-8');
    xhr.send(JSON.stringify(data));
  }

  return (
    <form id="contactForm" className={twMerge('', containerClass)} method="post'" onSubmit={sendData}>
